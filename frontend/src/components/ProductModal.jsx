...
export default function ProductModal({ product, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="my-auto w-full max-w-4xl animate-spring-in overflow-hidden rounded-3xl bg-white shadow-hover"
      ...
      >
        ...
        <div className="grid gap-6 px-6 pb-8 md:grid-cols-2 md:px-8">
          ...
          <div className="flex flex-col">
            <p className="text-xs font-bold uppercase tracking-wide text-accent-600 animate-badge">
              {product.brand || product.category}
            </p>
            <h2 className="mt-1 text-2xl font-extrabold leading-tight text-slate-900 animate-title">{product.name}</h2>
            ...
            <div className="mt-4 flex items-end gap-3 animate-row-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-600 animate-row-2">{product.description}</p>
            ...
            {!outOfStock && (
              <div className="mt-5 flex items-center gap-4">
                ...
                <button onClick={handleAdd} className={`btn-accent btn-3d flex-1 ${added ? "!bg-emerald-500 !text-white animate-bounce" : ""}`}>
                  {added ? (
                    <>
            ...
            <button
              ...
              className="btn-3d mt-4 flex w-full items-center justify-center gap-2 rounded-full border border-emerald-600 bg-emerald-50 px-5 py-2.5 text-sm font-bold text-emerald-700 shadow-soft transition hover:bg-emerald-100"
            >
